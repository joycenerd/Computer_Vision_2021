...
parser.add_argument('--model', type=str, default="efficientnet-b4",
                    help="which model: [resenest50, resnest101, resnest200, efficientnet-b4, efficientnet-b3]")
...
parser.add_argument('--checkpoint_dir', type=str, default=Path(ROOTPATH).joinpath(
    'checkpoint/efficientnet-b4'), help='Directory to save all your checkpoint.pth')
